...
BATS_FILES=(
  ...
  "$SCRIPT_DIR/entrypoint_shared_credentials_seed.bats"
  ...
  "$SCRIPT_DIR/instance_config_path.bats"
  "$SCRIPT_DIR/promote_credentials.bats"
  "$SCRIPT_DIR/backup_retention.bats"
  "$SCRIPT_DIR/backup_restore.bats"
  "$SCRIPT_DIR/backup_instance_subfolder.bats"
